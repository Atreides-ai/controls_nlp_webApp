...
const AtreidesLogo = (): JSX.Element => {
    ...
    return (
        <motion.svg
            className={classes.atreidesLogo}
            initial="hidden"
            animate="visible"
