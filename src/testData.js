const testData = [
    {
        ...
        contains_whos: true,
        control_description:
            'Creation of and changes to local Table of Authorities maintained manually must be approved by an independent authorised user before being made effective. The local Table of Authorities should be in keeping with the Global Table of Authorities.',
        ...
        cut_off: false,
        existence: true,
        hows: ['approved by an independent authorised user before being made effective'],
        ...
        thresholds: null,
        valuation: true,
        whats: ['maintained manually must be approved'],
        whens: ['Ad hoc'],
        whos: ['authorised user', 'Control Operator NOT EXPLICITLY PROVIDED'],
    },
];
